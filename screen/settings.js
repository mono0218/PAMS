        ...
        <NativeBaseProvider>
            ...
            <Box   width="100%" maxW="100%" bottom="0px" alignSelf="center" position="absolute">
                <HStack bg="white" width="100%" maxW="100%" alignItems="center" bottom="5px">
                    ...
                    <Pressable py="3" flex={1} >
                        <Center>
                            <IconButton icon={<Icon name="bell-outline" size={24} />} onPress={() => navigation.navigate('Notification') }/>
                            <Text color="black" fontSize="16">
                                履歴
                            </Text>
                        </Center>
                    ...
                    <Pressable py="3" flex={1} >
                        <Center>
                            <IconButton icon={<Icon name="cog" size={24} color="#0017C1"/>} onPress={() => navigation.navigate('settings') }/>
                            <Text color="black" fontSize="16">
                                設定
                            </Text>
                        </Center>
